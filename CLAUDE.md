...
dotnet test net.adamec.lib.common.dmn.engine.tests/net.adamec.lib.common.dmn.engine.tests.csproj --filter "FullyQualifiedName~SfeelExpressionsTests"
```
